...
export class QuoteComponent implements OnInit {
  quote: Quote[] = [
    ...
    new Quote(2,'love quotes','Love yourself first and everything else falls into line. You really have to love yourself to get anything done in this world.','dydy',new Date(2019,6,9)),
    ...
    new Quote(3,'success quotes','I’m a success today because I had a friend who believed in me and I didn’t have the heart to let him down.','pupe',new Date(2019,1,12)),
